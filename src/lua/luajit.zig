...
pub const LUAJIT_MODE_ENGINE = 0;
pub const LUAJIT_MODE_DEBUG = 1;
pub const LUAJIT_MODE_FUNC = 2;
pub const LUAJIT_MODE_ALLFUNC = 3;
pub const LUAJIT_MODE_ALLSUBFUNC = 4;
pub const LUAJIT_MODE_TRACE = 5;
pub const LUAJIT_MODE_WRAPCFUNC = 16;
pub const LUAJIT_MODE_MAX = 17;
pub extern fn luaJIT_setmode(L: ?*lua_State, idx: c_int, mode: c_int) c_int;
pub extern fn luaJIT_version_2_0_4() void;
...
pub const LUAJIT_MODE_FLUSH = 512;
...
pub const LUAJIT_VERSION_NUM = 20004;
...
pub const __SSE__ = 1;
pub const LUAJIT_COPYRIGHT = c"Copyright (C) 2005-2015 Mike Pall";
...
pub const LUAJIT_MODE_MASK = 255;
...
pub const LUAJIT_VERSION = c"LuaJIT 2.0.4";
...
pub const LUAJIT_VERSION_SYM = luaJIT_version_2_0_4;
pub const LUA_INTEGER = ptrdiff_t;
...
pub const LUAJIT_URL = c"http\x3a//luajit.org/";
