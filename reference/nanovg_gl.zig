pub const NVG_ANTIALIAS = enum_NVGcreateFlags.NVG_ANTIALIAS;
pub const NVG_STENCIL_STROKES = enum_NVGcreateFlags.NVG_STENCIL_STROKES;
pub const NVG_DEBUG = enum_NVGcreateFlags.NVG_DEBUG;
pub const enum_NVGcreateFlags = extern enum {
    NVG_ANTIALIAS = 1,
    NVG_STENCIL_STROKES = 2,
    NVG_DEBUG = 4,
};
pub const NVG_IMAGE_NODELETE = enum_NVGimageFlagsGL.NVG_IMAGE_NODELETE;
pub const enum_NVGimageFlagsGL = extern enum {
...
pub const __UINT64_FMTx__ = c"lx";
pub const NANOVG_GL_USE_STATE_FILTER = 1;
...
pub const NVGcreateFlags = enum_NVGcreateFlags;
pub const NVGimageFlagsGL = enum_NVGimageFlagsGL;
